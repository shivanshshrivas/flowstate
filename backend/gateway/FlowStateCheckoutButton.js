...
export function FlowStateCheckoutButton({ onClick, disabled = false, isConnected, amountLabel, className, title, }) {
    const label = isConnected
        ? `Pay with FlowState${amountLabel ? ` ${amountLabel}` : ""}`
        : "Connect Wallet to Checkout";
    return (_jsx("button", { type: "button", onClick: onClick, disabled: disabled, title: title, className: [
...
//# sourceMappingURL=FlowStateCheckoutButton.js.map