    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-8">
          <h1 className="text-xl font-semibold text-neutral-100 mb-1">Sign in as Seller</h1>
          <p className="text-sm text-neutral-400 mb-6">
            Don&apos;t have an account?{" "}
            <Link href="/auth/seller/signup" className="text-violet-400 hover:text-violet-300">
              Sign up
            </Link>
          </p>
          ...
          <div className="mt-6 rounded-lg bg-neutral-800/50 p-3 text-xs text-neutral-500 space-y-1">
            <p className="font-medium text-neutral-400">Demo seller account</p>
            <p>seller@demo.com</p>
