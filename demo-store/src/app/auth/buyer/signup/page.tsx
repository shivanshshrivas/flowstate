    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-8">
          <h1 className="text-xl font-semibold text-neutral-100 mb-1">Create a Buyer account</h1>
          <p className="text-sm text-neutral-400 mb-6">
            Already have an account?{" "}
            <Link href="/auth/buyer/login" className="text-violet-400 hover:text-violet-300">
              Sign in
            </Link>
          </p>
