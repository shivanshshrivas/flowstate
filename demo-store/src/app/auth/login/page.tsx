        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-sm font-medium text-neutral-100">Sign in as Buyer</p>
            ...
            >
              ...
              <p className="text-sm font-medium text-neutral-100">Sign in as Seller</p>
              <p className="text-xs text-neutral-500 mt-0.5">Manage your store</p>
            </Link>
          </div>

          <div className="mt-6 rounded-lg bg-neutral-800/50 p-3 text-xs text-neutral-500 space-y-1">
            <p className="font-medium text-neutral-400">Demo accounts</p>
            <p>buyer@demo.com · seller@demo.com</p>
